...
class ThreadBorderRouter {
  ...
  factory ThreadBorderRouter.fromJson(Map<String, dynamic> j) => ThreadBorderRouter(
    ...
    txt: (j['txt'] as Map<String, dynamic>? ?? {}).map((k, v) => MapEntry(k, v.toString())),
  );
...
class ThreadNeighborInfo {
  ...
  factory ThreadNeighborInfo.fromJson(Map<String, dynamic> j) => ThreadNeighborInfo(
...
class ThreadNetworkDiagnostics {
  ...
  factory ThreadNetworkDiagnostics.fromJson(Map<String, dynamic> j) => ThreadNetworkDiagnostics(
    ...
    neighbors:
        (j['neighbors'] as List<dynamic>?)
            ?.map((e) => ThreadNeighborInfo.fromJson(Map<String, dynamic>.from(e as Map)))
            .toList() ??
        [],
    routes:
        (j['routes'] as List<dynamic>?)
            ?.map((e) => ThreadRouteInfo.fromJson(Map<String, dynamic>.from(e as Map)))
            .toList() ??
        [],
  );
  final int? channel;
