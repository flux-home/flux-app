...
object AppFabricManager {
    ...
    /**
     * The app's operational identity for the CHIP controller — always the
     * locally-generated fabric.  Device control never uses this identity
     * (it's controller-proxied, see docs/controller-only-control.md); this
     * key only matters for the throwaway-fabric CASE session during BLE
     * commissioning and the ECM handoff.
     */
